...
u"""
Configuration of the demo scenario at EBU.
...
CHARTS_PATH = os.path.join(SCENARIO_PATH, 'charts')  # FIXME
...
EVENTS[u'amazon'] = EventsTable({
     0: {u'oscied-transform': 0, u'oscied-publisher': 0},
     8: {u'oscied-transform': 0, u'oscied-publisher': 0},
    17: {u'oscied-transform': 0, u'oscied-publisher': 0},
    18: {u'oscied-transform': 0, u'oscied-publisher': 0},
    20: {u'oscied-transform': 2, u'oscied-publisher': 0},
    23: {u'oscied-transform': 2, u'oscied-publisher': 0}
}, TIME_RANGE, TIME_SPEEDUP, sleep_factor=DAEMONS_CHECKS_PER_HOUR)
EVENTS[u'maas'] = EventsTable({
    0: {u'oscied-transform': 3, u'oscied-publisher': 1}
}, TIME_RANGE, TIME_SPEEDUP, sleep_factor=DAEMONS_CHECKS_PER_HOUR)
