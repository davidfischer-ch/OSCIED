...
class EBUEnvironment(OsciedEnvironment):
    ...
    def __init__(self, name, events=None, statistics=None, charts_path=None, enable_units_api=False,
        ...
        super(EBUEnvironment, self).__init__(name, **kwargs)
        self.events = events
...
class EBUEnvironmentThread(threading.Thread):

    def __init__(self, name, environment, daemon=True):
        super(EBUEnvironmentThread, self).__init__()
        self.name = name
...
class ScalingThread(EBUEnvironmentThread):
...
class StatisticsThread(EBUEnvironmentThread):
...
class TasksThread(EBUEnvironmentThread):
