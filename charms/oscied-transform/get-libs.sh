...
#wget -N http://download.tsi.telecom-paristech.fr/gpac/latest_builds/linux64/gpac/gpac_0.5.1.DEV-r5163_amd64.deb
#wget -N http://download.tsi.telecom-paristech.fr/gpac/latest_builds/linux32/gpac/gpac_0.5.1.DEV-r5163_i386.deb
